...
class PolynomialRegression(PALBase):
    ...
    def predict(self, data, key=None, features=None, model_format=None, thread_ratio=0.0):
        ...
        model_format : int or str, optional
        ...
        model_format = self._arg('model_format', model_format, (int, str))
        if isinstance(model_format, str):
            model_format = self._arg('model_format', model_format,
                                     dict(coefficient=0, pmml=1))
...
class CoxProportionalHazardModel(PALBase):
    ...
    @trace_sql
    def fit(self, data, key=None, features=None, label=None, status_col=None): # pylint: disable=too-many-locals
        r"""
        Fit regression model based on training data.
        ...
        features : list of str, optional
            Names of the feature columns(inclusive of convariates as well as status column).
        ...
        status_col : bool, optional
          ...
          - True : There is a status column in ``data``, of which 0 indicates
            right-censored data and 1 indicates failure/death. The column should correspond to:
    ...
    @trace_sql
    def predict(self, data, key=None, features=None, thread_ratio=0.0):
        r"""
        Predict dependent variable values based on fitted model.
